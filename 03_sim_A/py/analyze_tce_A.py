...
def main():
    ...
    rp = ensure_run_dirs_a(run_id, save_as_latest=False, meta={"script": "analyze_tce_A.py"})
    ...
    outputs = {"summary": overall_path.name, "by_distance": bydist_path.name}
    ...
    if overall["n_late"] == 0:
        ...
        if args.prefer_packet_deadline:
            print("[HINT] --prefer_packet_deadline is active. The packet-level deadline is overriding the profile deadline.")
